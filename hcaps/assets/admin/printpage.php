	...
	<aside>
		<div class="sidebar tngradient">
			<div class="div userprofile row">
				...
				<div class="p-0 col-md-10" style="background-color: ;">
...
<!-- Month -->
 ...
 <!-- <button class="btn btn-secondary" type="button" name="filterbut" id="filterbut">SUBMIT</button> -->
	...
	<button name="b_print" type="button" class="btn btn-default" onClick="printdiv('div1');">PRINT RESULTS</button>
...
// default
	...
	var hcase = $("#hcase").val();
	var year = $("#recordyear").val();
	var filters= "<h6>Filtered By : Year : " + year + " | Health Case : " + hcase + " | Month : " + month + " | Gender : " + sex + "</h6>";
